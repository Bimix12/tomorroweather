...
export const metadata: Metadata = {
  ...
  description:
    'Get accurate real-time weather forecasts and a 7-day outlook for any city in the world with Tomorrow Weather.',
  keywords: [
    'weather',
    'forecast',
    'weather forecast',
  ...
  openGraph: {
    ...
    description:
      'Get accurate real-time weather forecasts and a 7-day outlook for any city worldwide.',
